...
<!--
		<style>
			...
			.bg {
				/* The image used */
				background-image: url("documentation/images/background-dahlia.jpg");
				...
				<nav class="navbar navbar-expand-md navbar-light bg-light d-flex justify-content-end">
					...
					<div class="collapse navbar-collapse" id="navbarNav">
						<ul class="navbar-nav">
							...
							<li class="nav-item active">
								<a class="nav-link" href="#another-link-here">Neat!</a>
							</li>
							<li class="nav-item active">
					...
					<div class="row">
						<div class="col-sm-3">
							<img class="img-fluid d-block mx-auto"
								  src="documentation/images/Chrystal%20Copeland%20Headshot.jpg" alt="Chrystal Copeland">
						</div>
						<div class="col-sm-9">
					...
					<div class="row">
						<div class="col-lg-3 col-sm-6">
							<img class="img-fluid rounded d-block mx-auto mb-4"
								  src="documentation/images/bike%20abq.png" alt="ABQ Bike Trails">
							<div class="card mb-4">
								<div class="card-body">
						...
						<div class="col-lg-3 col-sm-6">
							<img class="img-fluid rounded d-block mx-auto mb-4"
								  src="documentation/images/tree-of-life.jpg" alt="Tree of Life Massage">
							<div class="card mb-4">
								<div class="card-body">
						...
						<div class="col-lg-3 col-sm-6">
							<img class="img-fluid rounded d-block mx-auto mb-4"
								  src="documentation/images/abq-pregnancy.png" alt="ABQ pregnancy">
							<div class="card mb-4">
								<div class="card-body">
						...
						<div class="col-lg-3 col-sm-6">
							<img class="img-fluid rounded d-block mx-auto mb-4"
								  src="documentation/images/youth-jazz.jpg" alt="Youth Jazz Collaborative">
							<div class="card mb-4">
								<div class="card-body">
			...
			<footer>
				<div class="container-fluid">
					<div class="sticky-footer text-center text-white bg-dark pt-2 pb-0 m-0 fixed-bottom">
						<p>
							<a href="https://github.com/chrystalcopeland/" target="_blank"><i class="fab fa-github fa-2x"></i></a>
							<a href="https://www.linkedin.com/in/copelandchrystal/" target="_blank"><i class="fab fa-linkedin fa-2x"></i></a>
							<a href="https://twitter.com/chryscopeland/" target="_blank"><i class="fab fa-twitter fa-2x"></i></a>
							<br>
