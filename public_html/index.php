			...
			<nav class="navbar navbar-expand-md navbar-light bg-light d-flex justify-content-end">
				...
				<h2 class="navbar-brand brand-name">
					<a href="index.html"><img class="img-responsive2"
													  src="images/dahlia-grey.png" height="50 px" width="50 px"></a>
				</h2>
		...
		<section class="py-5">
			<div class="container" id="portfolio">
				...
				<div class="row">
					...
					<div class="col-lg-3 col-sm-6">
						<img class="img-fluid rounded d-block mx-auto mb-4"
							  src="images/abq-pregnancy.png" alt="ABQ pregnancy">
						<div class="card mb-4">
							<div class="card-body">
					...
					<div class="col-lg-3 col-sm-6">
						<img class="img-fluid rounded d-block mx-auto mb-4"
							  src="images/youth-jazz.jpg" alt="Youth Jazz Collaborative">
						<div class="card mb-4">
							<div class="card-body">
									...
									<div class="row">
										<div class="col-lg-6 offset-lg-3">
											...
											<form id="contact-form" action="../php/mailer.php" method="post">
												...
												<div class="form-group">
													<label for="contactChrystalEmail">Email <span class="text-danger">*</span></label>
													<div class="input-group">
														<div class="input-group-prepend">
															<div class="input-group-text">
														...
														<input type="email" class="form-control" id="contactChrystalEmail" name="contactChrystalEmail" placeholder="Email">
													</div>
												</div>
												<div class="form-group">
													<label for="contactChrystalSubject">Subject</label>
													<div class="input-group">
														<div class="input-group-prepend">
															<div class="input-group-text">
														...
														<input type="text" class="form-control" id="contactChrystalSubject" name="contactChrystalSubject" placeholder="Subject">
													</div>
												</div>
												<div class="form-group">
													<label for="contactChrystalMessage">Message <span class="text-danger">*</span></label>
													<div class="input-group">
														<div class="input-group-prepend">
															<div class="input-group-text">
														...
														<textarea class="form-control" rows="5" id="contactChrystalMessage" name="contactChrystalMessage" placeholder="Message (2000 characters max)"></textarea>
													</div>
												</div>
												<!-- reCAPTCHA -->
